...
export const downloadDisbaled = (value) => ({
    type: actionTypes.DOWNLOAD_DISABLED,
    value
})
export const downloadAllDisbaled = (value) => ({
    type: actionTypes.DOWNLOADALL_DISABLED,
    value
})
...
export const tableDetail = (value) => ({
    type: actionTypes.TABLE_DETAIL,
    value
})
