...
import { Form, Input, Icon, Button, Upload, Row, Col, message } from 'antd';
...
class AddRadiusCertificateRegister extends Component {
    constructor(props) {
        super(props);
        this.state = {
            name: "",
    ...
    createRadiusCertificate = () => {
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                history.push("/certificate-management/free-radius-certificate")
            }
        });
    }
    returnList = () => {
                ...
                <div className="samp_panle_form">
                    <div className="samp_panel_form_header">
                        <span style={{ paddingLeft: "20px" }}>
                            Create Radius Server Certificates
                    </span>
                    </div>
...
const AddRadiusCertificate = Form.create()(AddRadiusCertificateRegister);
export default AddRadiusCertificate;