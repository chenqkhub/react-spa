...
export const disabledBeatch = (value) => ({
    type: actionTypes.BACTCH_DISABLED,
    value
})
export const importModal = (value) => ({
    type: actionTypes.IMPORT_SHOW,
    value
})
export const extendShow = (value) => ({
    type: actionTypes.EXTEND_SHOW,
    value
})
export const disabledExtend = (value) => ({
    type: actionTypes.EXTEND_DISABLED,
    value
})
...
export const accountType = (value) => ({
    type: actionTypes.ACCOUNT_TYPE,
    value
})
export const okButtonDisabled = (value) => ({
    type: actionTypes.OK_DISABLED,
    value
})
