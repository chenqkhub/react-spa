...
import { kickOffDisbaled, listData, createColumn, deleteShow, detailShow, selectedSize, selectedItem, kickOff, pageSize, currentPage } from '../../../actions/offline-device/actionCreator'
import columns from './OfflineDeviceTableConfig'
import OfflineDeviceDetail from './OfflineDeviceDetail'
const { TabPane } = Tabs;
const { Search } = Input;
const byod_list = [
    {
...
class OnlineDevice extends Component {
    constructor(props) {
        super(props);
        this.state = store.getState().offlineDeviceReducer
        //订阅redux的状态
        store.subscribe(this.storeChange)
    }
    storeChange = () => {
        this.setState(store.getState().offlineDeviceReducer)
    }
        ...
        return (
            <div>
                <Row>
                    ...
                    <Col span={10}>
                        {/* <Button type="primary" onClick={this.showKickOff}>Kick Off</Button> */}
                ...
                <Tabs defaultActiveKey="1" onChange={this.changeTheTabs}>
                    <TabPane tab="BYOD Offline Devices" key="1">
                    ...
                    <TabPane tab="Guest Offline Devices" key="2">
                    ...
                    <TabPane tab="Company Offline Devices" key="3">
                ...
                <Drawer
                    title="Offline Device Detail"
                    width={600}
                    closable={false}
                    onClose={this.onClose}
                    visible={this.state.visible}
                >
                    <OfflineDeviceDetail item={this.state.selectedItem} />
