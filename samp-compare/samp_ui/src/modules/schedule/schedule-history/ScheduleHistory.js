...
import { deleteDisbaled, editDisbaled, listData, createColumn, deleteShow, detailShow, selectedSize, selectedItem, pageSize, currentPage } from '../../../actions/schedule-history/actionCreator'
import ScheduleJobsDetail from './ScheduleHistoryDetail'
import columns from './ScheduleHistoryTableConfig'
...
class NasClients extends Component {
    constructor(props) {
        super(props);
        //获取state
        this.state = store.getState().scheduleHistoryReducer
        //订阅redux的状态
        store.subscribe(this.storeChange)
    }
    storeChange = () => {
        this.setState(store.getState().scheduleHistoryReducer)
    }
    ...
    getData = () => {
        ...
        const list = [
            {
                "id": 1, "key": "1", "group": "Poller", "handler": "DiscoveryUpDownUpdating", "endTime": 1571693242474, "startTime": 1571693242444, "result": "SUCCEEDED"

            },
            {
                "id": 2, "key": "2", "group": "Poller", "handler": "AutoSchedulerLocatorJob", "endTime": 1571693242474, "startTime": 1571693242444, "result": "SUCCEEDED"
            },
            {
                "id": 3, "key": "3", "group": "AFN", "handler": "AV License Audit", "endTime": 1571693242474, "startTime": 1571693242444, "result": "SUCCEEDED"
            },
            {
                "id": 4, "key": "4", "group": "Poller", "handler": "AV License Audit", "endTime": 1571693242474, "startTime": 1571693242444, "result": "SUCCEEDED"
            },
            {
                "id": 5, "key": "5", "group": "AFN", "handler": "AV License Audit", "endTime": 1571693242474, "startTime": 1571693242444, "result": "SUCCEEDED"
            },
            {
                "id": 6, "key": "6", "group": "Poller", "handler": "AV License Audit", "endTime": 1571693242474, "startTime": 1571693242444, "result": "SUCCEEDED"
            }
        ]
