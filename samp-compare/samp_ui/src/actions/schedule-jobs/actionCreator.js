...
export const stopDisabled = (value) => ({
    type: actionTypes.STOP_DISABLED,
    value
})
export const showStop = (value) => ({
    type: actionTypes.SHOW_STOP,
    value
})
export const pauseDisabled = (value) => ({
    type: actionTypes.PAUSE_DISABLED,
    value
})
export const showPause = (value) => ({
    type: actionTypes.SHOW_PAUSE,
    value
})
export const startDisabled = (value) => ({
    type: actionTypes.START_DISABLED,
    value
})
export const showStart = (value) => ({
